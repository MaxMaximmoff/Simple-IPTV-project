...
public class MySqlBase  extends SqlBase{
	...
	// Constructor of the MySQLBase class with the database name, username, and password
	public MySqlBase(String database_url, String user_login, String user_password) {
		
		super(database_url, user_login, user_password);
	}

	// Method for creating a new table in the MySQL database
	...
	// Method for deleting a table in the MySQL database
	...
	// Method for deleting all records in a MySQL database table	   
